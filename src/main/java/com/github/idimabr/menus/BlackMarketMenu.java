...
public class BlackMarketMenu extends PaginatedView<MarketData> {

    private MarketController marketController;
    private ConfigUtil config;

    public BlackMarketMenu(DevRoomMarket plugin, int row, String title) {
        super(row, title);
    ...
    protected void onRender(@NotNull ViewContext context) {
        List<MarketData> items = marketController.getBlackMarket();
    ...
    protected void onItemRender(@NotNull PaginatedViewSlotContext<MarketData> context, @NotNull ViewItem viewItem, @NotNull MarketData data) {
        final ConfigurationSection item = config.getConfigurationSection("menus.blackmarket.item-format");
